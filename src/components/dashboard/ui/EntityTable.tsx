                ...
                <tr key={entity.id} className="group hover:bg-white/[0.02] transition-colors border-b border-glass-border/50 last:border-0">
                  ...
                  <td className="p-4 text-right">
                    <button 
                      ...
                      className="font-serif text-[0.55rem] tracking-[0.2em] text-mythos-accent/70 hover:text-mythos-accent uppercase flex items-center justify-end gap-1.5 ml-auto transition-colors group-hover:drop-shadow-[0_0_5px_rgba(212,175,55,0.5)] border-none bg-transparent cursor-pointer"
                    >
                      Görüntüle <span>→</span>
                    </button>
                  </td>
